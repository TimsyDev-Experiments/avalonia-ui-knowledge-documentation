...
2. [002 — Command Binding](02-tutorials/basics/002-command-binding.md)
   ...
   ⌞ [002Q — Command Binding (quiz)](02-tutorials/basics/002-command-binding-quiz.md)
3. [003 — Basic Styling](02-tutorials/basics/003-basic-styling.md)
   ...
   ⌞ [003Q — Basic Styling (quiz)](02-tutorials/basics/003-basic-styling-quiz.md)
4. [004 — Value Converters](02-tutorials/basics/004-value-converters.md)
   ...
   ⌞ [004Q — Value Converters (quiz)](02-tutorials/basics/004-value-converters-quiz.md)
5. [005 — Binding Modes](02-tutorials/basics/005-binding-modes.md)
   ...
   ⌞ [005Q — Binding Modes (quiz)](02-tutorials/basics/005-binding-modes-quiz.md)
6. [006 — Resources (Static & Dynamic)](02-tutorials/basics/006-resources.md)
   ...
   ⌞ [006Q — Resources (quiz)](02-tutorials/basics/006-resources-quiz.md)
7. [007 — ObservableObject & ObservableProperty](02-tutorials/basics/007-observable-object-property.md)
   ...
   ⌞ [007Q — ObservableObject & ObservableProperty (quiz)](02-tutorials/basics/007-observable-object-property-quiz.md)
8. [008 — RelayCommand (sync & async)](02-tutorials/basics/008-relay-command.md)
   ...
   ⌞ [008Q — RelayCommand (quiz)](02-tutorials/basics/008-relay-command-quiz.md)
9. [009 — Data Templates Basics](02-tutorials/basics/009-data-templates-basics.md)
   ...
   ⌞ [009Q — Data Templates (quiz)](02-tutorials/basics/009-data-templates-basics-quiz.md)
10. [010 — Window Basics & Simple Dialogs](02-tutorials/basics/010-window-dialog-basics.md)
   ...
   ⌞ [010Q — Window & Dialogs Basics (quiz)](02-tutorials/basics/010-window-dialog-basics-quiz.md)
...
1. [011 — Compiled Bindings in Depth](02-tutorials/intermediate/011-compiled-bindings.md)
   ...
   ⌞ [011Q — Compiled Bindings (quiz)](02-tutorials/intermediate/011-compiled-bindings-quiz.md)
2. [012 — Control Themes vs Styles](02-tutorials/intermediate/012-control-themes-vs-styles.md)
   ...
   ⌞ [012Q — Control Themes vs Styles (quiz)](02-tutorials/intermediate/012-control-themes-vs-styles-quiz.md)
3. [013 — Data Validation (ObservableValidator)](02-tutorials/intermediate/013-data-validation.md)
   ...
   ⌞ [013Q — Data Validation (quiz)](02-tutorials/intermediate/013-data-validation-quiz.md)
4. [014 — IMessenger Patterns](02-tutorials/intermediate/014-imessenger-patterns.md)
   ...
   ⌞ [014Q — IMessenger Patterns (quiz)](02-tutorials/intermediate/014-imessenger-patterns-quiz.md)
5. [015 — Item Lists (ListBox, ItemsRepeater, DataGrid)](02-tutorials/intermediate/015-item-lists.md)
   ...
   ⌞ [015Q — Item Lists (quiz)](02-tutorials/intermediate/015-item-lists-quiz.md)
6. [016 — Window & Dialog Management](02-tutorials/intermediate/016-window-dialog-management.md)
   ...
   ⌞ [016Q — Window & Dialog Mgmt (quiz)](02-tutorials/intermediate/016-window-dialog-management-quiz.md)
7. [017 — Theme Switching (Light/Dark/System)](02-tutorials/intermediate/017-theme-switching.md)
   ...
   ⌞ [017Q — Theme Switching (quiz)](02-tutorials/intermediate/017-theme-switching-quiz.md)
8. [018 — Navigation Patterns](02-tutorials/intermediate/018-navigation.md)
   ...
   ⌞ [018Q — Navigation (quiz)](02-tutorials/intermediate/018-navigation-quiz.md)
9. [019 — Drag & Drop](02-tutorials/intermediate/019-drag-drop.md)
   ...
   ⌞ [019Q — Drag & Drop (quiz)](02-tutorials/intermediate/019-drag-drop-quiz.md)
10. [040 — DataGrid Deep Dive](02-tutorials/intermediate/040-datagrid-deep-dive.md)
   ...
   ⌞ [040Q — DataGrid Deep Dive (quiz)](02-tutorials/intermediate/040-datagrid-deep-dive-quiz.md)
11. [041 — Menus, Context Menus, and System Tray](02-tutorials/intermediate/041-menus-context-menus-tray.md)
   ...
   ⌞ [041Q — Menus & Tray (quiz)](02-tutorials/intermediate/041-menus-context-menus-tray-quiz.md)
...
1. [020 — Custom Templated Controls](02-tutorials/advanced/020-custom-templated-controls.md)
   ...
   ⌞ [020Q — Custom Templated Controls (quiz)](02-tutorials/advanced/020-custom-templated-controls-quiz.md)
2. [021 — Custom Controls from Scratch](02-tutorials/advanced/021-custom-controls-from-scratch.md)
   ...
   ⌞ [021Q — Custom Controls from Scratch (quiz)](02-tutorials/advanced/021-custom-controls-from-scratch-quiz.md)
3. [022 — Attached Properties & Behaviors](02-tutorials/advanced/022-attached-properties-behaviors.md)
   ...
   ⌞ [022Q — Attached Properties & Behaviors (quiz)](02-tutorials/advanced/022-attached-properties-behaviors-quiz.md)
4. [023 — Custom Layout Panels](02-tutorials/advanced/023-custom-layout-panels.md)
   ...
   ⌞ [023Q — Custom Layout Panels (quiz)](02-tutorials/advanced/023-custom-layout-panels-quiz.md)
5. [024 — Animation & Transitions](02-tutorials/advanced/024-animation-transitions.md)
   ...
   ⌞ [024Q — Animation & Transitions (quiz)](02-tutorials/advanced/024-animation-transitions-quiz.md)
6. [025 — Compositor & Custom Visuals](02-tutorials/advanced/025-compositor-custom-visuals.md)
   ...
   ⌞ [025Q — Compositor & Custom Visuals (quiz)](02-tutorials/advanced/025-compositor-custom-visuals-quiz.md)
7. [026 — Accessibility & Automation](02-tutorials/advanced/026-accessibility-automation.md)
   ...
   ⌞ [026Q — Accessibility & Automation (quiz)](02-tutorials/advanced/026-accessibility-automation-quiz.md)
8. [027 — Advanced Composite Bindings](02-tutorials/advanced/027-advanced-composite-bindings.md)
   ...
   ⌞ [027Q — Advanced Composite Bindings (quiz)](02-tutorials/advanced/027-advanced-composite-bindings-quiz.md)
9. [028 — Custom Drawing with Skia](02-tutorials/advanced/028-custom-drawing-skia.md)
   ...
   ⌞ [028Q — Custom Drawing with Skia (quiz)](02-tutorials/advanced/028-custom-drawing-skia-quiz.md)
10. [029 — Using Avalonia DevTools](02-tutorials/advanced/029-avalonia-plus-devtools.md)
   ...
   ⌞ [029Q — DevTools (quiz)](02-tutorials/advanced/029-avalonia-plus-devtools-quiz.md)
11. [030 — Parcel Packaging & Distribution](02-tutorials/advanced/030-parcel-packaging.md)
   ...
   ⌞ [030Q — Parcel Packaging (quiz)](02-tutorials/advanced/030-parcel-packaging-quiz.md)
12. [031 — Custom Theme & Design System](02-tutorials/advanced/031-custom-theme-design-system.md)
   ...
   ⌞ [031Q — Custom Theme & Design System (quiz)](02-tutorials/advanced/031-custom-theme-design-system-quiz.md)
13. [032 — MVVM with Dependency Injection](02-tutorials/advanced/032-mvvm-di-wiring.md)
   ...
   ⌞ [032Q — MVVM DI Wiring (quiz)](02-tutorials/advanced/032-mvvm-di-wiring-quiz.md)
14. [033 — Localization & i18n](02-tutorials/advanced/033-localization-i18n.md)
   ...
   ⌞ [033Q — Localization & i18n (quiz)](02-tutorials/advanced/033-localization-i18n-quiz.md)
15. [034 — File Pickers & Platform Services](02-tutorials/advanced/034-file-pickers-platform-services.md)
   ...
   ⌞ [034Q — File Pickers & Platform (quiz)](02-tutorials/advanced/034-file-pickers-platform-services-quiz.md)
16. [035 — Custom Dialogs & Window Management](02-tutorials/advanced/035-custom-dialogs-window-management.md)
   ...
   ⌞ [035Q — Custom Dialogs (quiz)](02-tutorials/advanced/035-custom-dialogs-window-management-quiz.md)
17. [036 — Virtualization & Large List Performance](02-tutorials/advanced/036-virtualization-large-lists.md)
   ...
   ⌞ [036Q — Virtualization & Large Lists (quiz)](02-tutorials/advanced/036-virtualization-large-lists-quiz.md)
18. [037 — App Lifetimes & Splash Screen](02-tutorials/advanced/037-app-lifetimes-splash-screen.md)
   ...
   ⌞ [037Q — App Lifetimes & Splash Screen (quiz)](02-tutorials/advanced/037-app-lifetimes-splash-screen-quiz.md)
19. [038 — Headless Testing](02-tutorials/advanced/038-headless-testing.md)
   ...
   ⌞ [038Q — Headless Testing (quiz)](02-tutorials/advanced/038-headless-testing-quiz.md)
20. [039 — NativeAOT & Trimming](02-tutorials/advanced/039-nativeaot-trimming.md)
   ...
   ⌞ [039Q — NativeAOT & Trimming (quiz)](02-tutorials/advanced/039-nativeaot-trimming-quiz.md)
21. [042 — Multi-Targeting: Desktop, Browser, Mobile](02-tutorials/advanced/042-multi-targeting-desktop-browser-mobile.md)
   ...
   ⌞ [042Q — Multi-Targeting (quiz)](02-tutorials/advanced/042-multi-targeting-desktop-browser-mobile-quiz.md)
22. [044 — Background Services & Progress Reporting](02-tutorials/advanced/044-background-services-and-progress.md)
   ...
   ⌞ [044Q — Background Services & Progress (quiz)](02-tutorials/advanced/044-background-services-and-progress-quiz.md)
23. [045 — CI/CD for Avalonia Applications](02-tutorials/advanced/045-cicd-for-avalonia.md)
   ...
   ⌞ [045Q — CI/CD for Avalonia (quiz)](02-tutorials/advanced/045-cicd-for-avalonia-quiz.md)
24. [046 — Logging & Telemetry](02-tutorials/advanced/046-logging-telemetry.md)
   ...
   ⌞ [046Q — Logging & Telemetry (quiz)](02-tutorials/advanced/046-logging-telemetry-quiz.md)
25. [047 — Charts & Data Visualization](02-tutorials/intermediate/047-charts-data-visualization.md)
   ...
   ⌞ [047Q — Charts & Data Viz (quiz)](02-tutorials/intermediate/047-charts-data-visualization-quiz.md)
26. [048 — SQLite / Local Database](02-tutorials/intermediate/048-sqlite-local-database.md)
   ...
   ⌞ [048Q — SQLite / Local DB (quiz)](02-tutorials/intermediate/048-sqlite-local-database-quiz.md)
